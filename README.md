> **Notice:** - _**Please migrate to the new and improved [BASC-py4chan](https://github.com/bibanon/BASC-py4chan) wrapper**, it has many improvements and new features (such as catalog support.)_  
